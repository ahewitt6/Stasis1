...
###########################
# Flag for STASIS Cosmology
###########################
stasis_flag = True
# Omega_stasis = 0.5
# stasis_params = {
#     "Omega_M": 0.4, # OmegaM during stasis. This will calculate the equation of state parameter w
#     "T_start_K": 8.*MeV_to_Kelvin, # Start Temp 
#     "T_end_K": 5.*MeV_to_Kelvin, # End Temp  # ρ_tower / ρ_rad
#     "rho_m0": 1.0,
#     "dyn_T_end": None,
#     # new tower‐decay settings:
#     "N_rungs": 100,       # how many discrete decays you want

#     # internal state
#     "rho_rad_entry": None,   # will be set to ρ_rad(T_entry)
#     "injection_done": 0.0,    # total decay‐energy injected so far

#     # "tower_initialized": False,  # have we set up the tower reservoir?
#     # "tower_finalized": False,   # mark once dyn_T_end set
#     # "rho_tower_total": 0.0,    # total energy to feed into radiation
#     # "rho_tower_prev": 0.0,    # tower energy remaining at last call
#     # "rho_initial": 1e20 # Initial energy density (erg/cm^3)
# }

stasis_m0 = 1e0 # in MeV
...
stasis_params = {
    ...
    "Delta_m": stasis_m0,
    "N_SPECIES": 5, #10
    "GAMMA_OVER_H": 100,#1e6 
    "stasis_start_MeV": 10,         #obsolete parameter
    "tiny_radiation": 0.5,
    "plasma_inject_frac": 1,    #1 dumps it %100 into photons
}
