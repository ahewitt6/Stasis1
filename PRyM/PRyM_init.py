...
T_start = 6e1*MeV_to_Kelvin # O(10^-2) [s]
...
nacreii_flag = True # as default code adopts PRIMAT compilation for nuclear rates
if(nacreii_flag):
...
stasis_params = {
    #"alpha": 1, #this is just a dummy, its updated to the constrained value for stasis
    "gamma": 7,
    "delta": 1,
    "m0": 1,          
    "Delta_m": 1,
    "N_SPECIES": 10, #10
    "GAMMA_OVER_H": 1e5, # should not affect stuff as of now
    "stasis_end_mev": 50,
    "tiny_radiation": 0.01,
    "plasma_inject_frac": 0.1, 
}

stasis_params["alpha"] = (2/7)*stasis_params["gamma"] - 1/stasis_params["delta"]
